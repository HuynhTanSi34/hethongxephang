...
function Updateaccounted({ listData, fetchLists }: any) {
  useEffect(() => {
    fetchLists();
  }, []);
  ...
  return (
    <div>
      ...
      <div className={classes.title12}>Cập nhật tài khoản</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Updateaccounted);

...
function Addoleuse({ listData, fetchLists }: any) {
  useEffect(() => {
    fetchLists();
  }, []);
  ...
  return (
    <div>
      ...
      <div className={classes.title12}>Thêm vai trò</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Addoleuse);
